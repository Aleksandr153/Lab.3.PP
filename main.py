...
html_string = read_html_file('Email.html') #Эта строка вызывает функцию read_html_file с именем файла 'test.html' и присваивает возвращенное содержимое HTML переменной html_string.
